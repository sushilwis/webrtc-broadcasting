...
var broadcast = function(config) {
    ...
    console.log("the broadcast function starts.");
    ...
    function openDefaultSocket(callback) {
        ...
        console.log("from the open default socket.");
    ...
    function onDefaultSocketResponse(response) {
        ...
        console.log("from the on default socket responce.");
    ...
    function openSubSocket(_config) {
        ...
        var peerConfig = {
            ...
            onRemoteStream: function(stream) {
                ...
                console.log("from on remote stream.");
        ...
        function onRemoteStreamStartsFlowing() {
            ...
            console.log("from on remote stream strats flowing.");
        ...
        function afterRemoteStreamStartedFlowing() {
            ...
            console.log("from after remote stream strats flowing.");
        ...
        function socketResponse(response) {
            ...
            console.log("from socket response.");
    ...
    function startBroadcasting() {
        ...
        console.log("from start broadcasting.");
